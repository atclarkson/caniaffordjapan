 ...
 *  English only for now: caniaffordjapan.com targets English-language
 *  search first. Add "fr" back here (and its localeMeta entry, and a
 *  src/i18n/ui/fr/ dictionary) if French coverage becomes worth it. */
