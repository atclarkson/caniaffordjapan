...
export const enChrome = {
  ...
  nav: {
    ...
    brandHome: "Can I Afford Japan?, back to the home page",
  ...
  footer: {
    tagline:
      "Can I Afford Japan? is the running, honest answer to that question, from the Clarkson family's own trips. Real photos, real prices, no guessing.",
    colRead: "Read",
    colStudio: "About",
    colLegal: "Legal",
    rss: "RSS feed",
